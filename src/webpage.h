...
<body>
            ...
            <div class="card">
                ...
                <div class="gauge-container">
                    ...
                    <div class="gauge-wrapper">
                        <div class="gauge-value" id="nitrogen-value">--</div>
                ...
                <div class="gauge-container">
                    ...
                    <div class="gauge-wrapper">
                        <div class="gauge-value" id="phosphorus-value">--</div>
                        <div class="gauge-track">
                ...
                <div class="gauge-container">
                    ...
                    <div class="gauge-wrapper">
                        <div class="gauge-value" id="potassium-value">--</div>
                        <div class="gauge-track">
                ...
                <div class="sensor-grid">
                    <div class="sensor-item">
                        ...
                        <div class="sensor-info">
                            ...
                            <div class="trend" id="temperature-trend">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <script>
        ...
        function updateData() {
            fetch('/data')
                ...
                .then(data => {
                    ...
                    // Update gauges
                    if (data.nitrogen >= 0) {
                        const nitrogenValue = data.nitrogen.toFixed(1);
                        document.getElementById('nitrogen-value').textContent = nitrogenValue;
                        document.getElementById('nitrogen-gauge').style.width = `${Math.min(data.nitrogen, 100)}%`;
                    }
                    if (data.phosphorus >= 0) {
                        const phosphorusValue = data.phosphorus.toFixed(1);
                        document.getElementById('phosphorus-value').textContent = phosphorusValue;
                        document.getElementById('phosphorus-gauge').style.width = `${Math.min(data.phosphorus, 100)}%`;
                    }
                    if (data.potassium >= 0) {
                        const potassiumValue = data.potassium.toFixed(1);
                        document.getElementById('potassium-value').textContent = potassiumValue;
                        document.getElementById('potassium-gauge').style.width = `${Math.min(data.potassium, 100)}%`;
                    }
        ...
        // Update only GPS every 10 seconds
        updateGPS();
